  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden">
        <div
          aria-hidden
          className="absolute -top-24 -right-24 h-72 w-72 rounded-full bg-amber-900/20 blur-2xl"
        />
        <div
          aria-hidden
          className="absolute top-40 -left-20 h-56 w-56 rounded-full bg-amber-500/10 blur-2xl"
        />
        <div className="relative mx-auto max-w-6xl px-4 pt-16 pb-14 text-center sm:pt-24 sm:pb-20">
          <span className="inline-flex items-center gap-1.5 rounded-full border border-white/10 bg-surface px-4 py-1.5 text-xs font-bold text-white/60 shadow-sm">
            ☕ Komunitas barista Indonesia
          </span>
          <h1 className="mx-auto mt-6 max-w-2xl text-4xl leading-tight font-extrabold tracking-tight text-white sm:text-5xl">
      ...
      <section className="mx-auto max-w-6xl px-4 pb-16">
        ...
        {jobs.length > 0 ? (
          ...
          <div className="rounded-2xl border border-dashed border-white/10 bg-surface/60 px-6 py-12 text-center">
      ...
      {/* How it works */}
      <section className="border-t border-white/10/60 bg-surface/50">
        <div className="mx-auto grid max-w-6xl gap-6 px-4 py-14 sm:grid-cols-2">
          {steps.map((s) => (
            <div
              key={s.title}
              className="flex items-start gap-4 rounded-2xl border border-white/10 bg-surface p-6"
            >
