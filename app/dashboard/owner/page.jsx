                    ...
                    {jobs.map(job => (
                      <tr key={job.id} className="hover:bg-cream/50">
                        ...
                        <td className="px-5 py-3 text-right flex items-center justify-end gap-2">
                          <Link href={`/dashboard/owner/jobs/${job.id}`} className="text-xs font-bold text-espresso hover:text-caramel inline-flex items-center gap-1"><Eye size={14}/>Kelola</Link>
                ...
                {jobs.map(job => (
                  <div key={job.id} className="rounded-xl border border-latte p-4">
                    ...
                    <div className="flex gap-2 mt-3">
                      <Link href={`/dashboard/owner/jobs/${job.id}`} className="flex-1 text-center text-xs font-bold bg-espresso text-white py-2 rounded-full">Kelola</Link>
