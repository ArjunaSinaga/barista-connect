...
export const SKILL_LABELS = {
  "Latte Art": "Seni Latte",
  "Manual Brew": "Seduh Manual",
  "Espresso Bar": "Bar Espresso",
  "Roasting": "Sangrai",
  "Cupping": "Cupping",
  "Cold Brew": "Cold Brew",
  "Tea & Non-Coffee": "Teh & Non-Kopi",
  "Customer Service": "Pelayanan",
  "Cashier POS": "Kasir",
  "Bar Back": "Asisten Bar",
};

// Label tampil Bahasa Indonesia; nilai tersimpan & query cari tetap aslinya.
export const skillLabel = (s) => SKILL_LABELS[s] ?? s;
...
export const STATUS_META = {
  ...
  terminated: { label: "Dikeluarkan", classes: "bg-orange-100 text-orange-700" },
};
