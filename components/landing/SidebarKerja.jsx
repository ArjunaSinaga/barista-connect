...
export function AcademyCard({ image }) {
  return (
    <div className="rounded-2xl border border-[#e8e0cf] bg-[#ffffff] p-4 shadow-[0_1px_3px_rgba(43,33,24,0.08)]">
      ...
      <div className="mt-2 grid items-center gap-3 sm:grid-cols-[1fr_150px] lg:grid-cols-1 xl:grid-cols-[1fr_150px]">
        <div className="min-w-0">
          <p className="text-[15px] leading-6 font-bold text-[#2b2118]">Barista training for a brighter tomorrow.</p>
        ...
        <div className="relative hidden overflow-hidden rounded-xl sm:block">
          {image ? (
            <img src={image} alt="Barista training" loading="lazy" className="aspect-[4/5] w-full object-cover" />
          ) : (
            <div className="flex aspect-[4/5] w-full items-center justify-center bg-[#efe8d8] text-xs text-[#857768]">Training photo</div>
          )}
...
export function SmarterOpsCard() {
  return (
    <div className="rounded-2xl border border-[#e8e0cf] bg-[#ffffff] p-4 shadow-[0_1px_3px_rgba(43,33,24,0.08)]">
      ...
      <p className="mt-1 text-[15px] leading-6 font-bold text-[#2b2118]">See more than just talent. Build a better team.</p>
      <p className="mt-1 text-xs leading-5 text-[#857768]">
      ...
      <div className="mt-3 rounded-xl bg-[#faf7ef] p-3">
        <div className="flex items-center justify-between">
          <p className="text-[11px] font-bold text-[#2b2118]">Team Overview (Phase 2)</p>
