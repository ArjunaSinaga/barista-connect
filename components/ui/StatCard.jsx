...
export default function StatCard({
  ...
  return (
    <div className="rounded-2xl border border-[#e8e0cf] bg-[#ffffff] p-3 shadow-[0_1px_3px_rgba(43,33,24,0.08)]">
      ...
      >
        {Icon && circled && (
          <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[#efe9d9] text-[#3d2c1e]">
      ...
      <p className={`mt-1 text-2xl font-black tracking-tight tabular-nums ${valueClass}`}>{value}</p>
      {(sub || delta) && (
