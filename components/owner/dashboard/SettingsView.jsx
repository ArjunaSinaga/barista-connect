  ...
  return (
    <>
      <div className="flex flex-wrap items-center justify-between gap-3">
        <p className="text-[11px] font-bold tracking-[0.18em] text-espresso-soft uppercase">Settings</p>
        <div className="flex flex-wrap items-center gap-2">
          ...
          {publicHref && (
            <Link href={publicHref} className="inline-flex items-center gap-1.5 rounded-full border border-[#e0d5bd] bg-white px-4 py-2 text-xs font-bold text-link hover:underline">
      ...
      <div className="overflow-hidden rounded-xl border border-[#e8e0cf] bg-white">
