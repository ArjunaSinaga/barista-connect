...
export default function JobsProfileCard({ barista, appliedCount, savedCount = 0, isOwner = false }) {
  if (isOwner) {
    return (
      <div className="rounded-2xl border border-[#e8e0cf] bg-[#ffffff] p-5 text-center shadow-[0_1px_3px_rgba(43,33,24,0.08)]">
        <p className="text-sm font-extrabold text-[#2b2118]">Kelola loker kafemu dari dashboard owner.</p>
        <Link
  ...
  if (!barista) {
    return (
      <div className="rounded-2xl border border-[#e8e0cf] bg-[#ffffff] p-5 text-center shadow-[0_1px_3px_rgba(43,33,24,0.08)]">
        <p className="text-sm font-extrabold text-[#2b2118]">Kopi enak berawal dari orang hebat.</p>
  ...
  return (
    <div className="min-w-0 space-y-3">
      <div className="rounded-2xl border border-[#e8e0cf] bg-[#ffffff] p-5 text-center shadow-[0_1px_3px_rgba(43,33,24,0.08)]">
        ...
        <p className="mt-0.5 text-xs text-[#857768]">Barista • Pecinta Kopi</p>
        ...
        <div className="mt-3 flex items-stretch justify-center gap-4 text-center">
          ...
          <div className="border-l border-[#e8e0cf] pl-4">
            ...
            <p className="text-[10px] text-[#857768]">Skill</p>
          </div>
          <div className="border-l border-[#e8e0cf] pl-4">
            <p className="text-sm font-extrabold text-[#2b2118] tabular-nums">{appliedCount}</p>
            <p className="text-[10px] text-[#857768]">Dilamar</p>
          </div>
        </div>
        <Link
      ...
      <nav aria-label="Loker" className="rounded-2xl border border-[#e8e0cf] bg-[#ffffff] p-2 shadow-[0_1px_3px_rgba(43,33,24,0.08)]">
